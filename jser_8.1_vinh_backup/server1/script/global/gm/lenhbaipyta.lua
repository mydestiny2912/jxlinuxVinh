...
function main()
	...
	local tbSay = {format(TITLEDIALOG, GetName(), GetAccount() ,nW,nX,nY)};
		tinsert(tbSay, "NhËn hç trî/CacLoaiDiem");
        ...
        --tinsert(tbSay, "Sö dông b¹ch c©u hoµn/bachcauhoan");
...
function kiemtranpc()
 ...
 Msg2Player(strchar(34)..", "..Name..", "..IdNpc..", "..nScript..strchar(34))
 local file  = openfile("npcinfo.lua", "a+")
 write(file,strchar(34)..", "..Name..", "..IdNpc..", "..nScript..strchar(34),'\n')
 closefile(file)
...
function bachcauhoan()
	...
	ntotaltime=sparetime + (AEXP_SMALLCHANGE*3);
